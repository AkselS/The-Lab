...
bool LightShader::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	result = D3DX11CompileFromFile("light.vs", NULL, NULL, "LightVertexShader", "vs_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, NULL,
	...
	if (FAILED(result))
	{
		...
		{
			MessageBox(hwnd, "light.vs", "Missing Shader File", MB_OK);
		}
	...
	result = D3DX11CompileFromFile("light.ps", NULL, NULL, "LightPixelShader", "ps_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, NULL,
	...
	if (FAILED(result))
	{
		...
		{
			MessageBox(hwnd, "light.ps", "Missing Shader File", MB_OK);
		}
